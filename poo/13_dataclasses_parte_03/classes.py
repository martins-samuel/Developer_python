...
class PessoaJuridica(Pessoa):
    ...
    def __str__(self):
        return f"Somos da empresa {self.nome_fantasia}, com CNPJ {self.cnpj}. Nosso website é {self.website}, nosso e-mail é {self.email}, nosso telefone é {self.telefone}, é nosso endereço é {self.endereco}"
